...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Cute", "Ugly", "Dumb", "Happy", "Awesome", "Old"];
  string[] secondWords = ["Lion", "Whale", "Elephant", "Fish", "Wolf", "Panda"];
  string[] thirdWords = ["Green", "Yellow", "Cyan", "Pink", "Black", "White"];
